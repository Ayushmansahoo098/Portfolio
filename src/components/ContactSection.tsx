  ...
  return (
    <section id="contact" className="py-24 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto space-y-16">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
        ...
        <div className="lg:col-span-5 space-y-6">
          ...
          <div className="space-y-3 font-mono text-xs">
            <a
              ...
              className="flex items-center justify-between p-4 rounded-xl glass-panel hover:border-[#990026] hover:bg-[#120508] text-slate-200 transition-all group bg-[#080305]"
            >
              <div className="flex items-center space-x-3">
                <Github className="w-5 h-5 text-[#E01E43] group-hover:scale-110 transition-transform" />
                <span>github.com/Ayushmansahoo098</span>
              </div>
            ...
            >
              <div className="flex items-center space-x-3">
                ...
                <span>linkedin.com/in/ayush-man-sahoo</span>
              </div>
              <span className="text-slate-500">→</span>
            </a>
            ...
            >
              <div className="flex items-center space-x-3">
                <Mail className="w-5 h-5 text-[#B8002E] group-hover:scale-110 transition-transform" />
                <span>{PORTFOLIO_DATA.personal.socials.email}</span>
              </div>
              <span className="text-slate-500">→</span>
            </a>
          </div>
        ...
        <div className="lg:col-span-7 glass-panel p-8 sm:p-10 rounded-2xl border border-white/10 space-y-6 bg-[#080305]">
          ...
          {submitted ? (
            <motion.div
              ...
              className="p-8 rounded-xl bg-[#4A0012]/40 border border-[#990026] text-center space-y-3 font-mono text-xs"
            >
              <CheckCircle2 className="w-10 h-10 text-[#E01E43] mx-auto" />
            ...
            <form onSubmit={handleSubmit} className="space-y-4 font-mono text-xs">
              <div className="space-y-1">
                ...
                <input
                  ...
                  className="w-full p-3 rounded-xl bg-slate-950 border border-white/10 text-white placeholder-slate-600 focus:outline-none focus:border-[#990026] transition-colors"
                />
              </div>
              ...
              <button
                type="submit"
                data-cursor="SEND MESSAGE"
                className="w-full py-3.5 rounded-xl bg-[#6D001A] hover:bg-[#8E0022] text-white font-bold text-xs font-mono flex items-center justify-center space-x-2 transition-all shadow-lg shadow-[#6D001A]/30 border border-[#990026]"
              >
